...
#----------------------------
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (1,'layoutimage',1,'big','big','gif',404,53,'antville.org');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT) values (2,'layoutimage',1,'headbg','headbg','gif',3,52);
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (3,'layoutimage',1,'menu','menu','gif',36,13,'menu');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (4,'layoutimage',1,'recent','recent','gif',123,13,'recently modified');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (5,'layoutimage',1,'status','status','gif',48,13,'status');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (6,'layoutimage',1,'dot','dot','gif',30,30,'dots');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (7,'layoutimage',1,'bullet','bullet','gif',3,10,'bullet');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (8,'layoutimage',1,'webloghead','webloghead','gif',404,53,'head');
insert into AV_IMAGE (IMAGE_ID,IMAGE_PROTOTYPE,IMAGE_F_LAYOUT,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (9,'layoutimage',1,'manage','manage','gif',50,13,'manage');
