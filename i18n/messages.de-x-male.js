...
global.messages['de-x-male'] = {
  ...
  "If the user did not include contact information in the message itself, you can send your reply via the user’s contact form [2].": "Falls der Absender der Nachricht keine Kontaktinformationen hinzugefügt hat, können Sie Ihre Antwort über das Kontaktformular senden [2].",
  ...
  "Please enter your message to the user below.": "Bitte geben Sie Ihre Nachricht an den Empfänger ein.",
  ...
  "The only owner of a site cannot be removed.": "Der einzige Eigentümer einer Website kann nicht gelöscht werden.",
  ...
  "This message was sent to you by an anonymous user of the site {0} [1].": "Diese Nachricht wurde Ihnen von einem unbekannten Absender der Website {0} gesendet [1].",
