...
global.messages['de'] = {
  ...
  "Referrers and backlinks are processed in your browser to reduce spam. To see them, your browser needs to permit the execution of JavaScript.": "Um Spam zu vermindern, werden Rückverweise in Ihrem Browser bearbeitet. Dazu muss im Browser JavaScript aktiviert sein.",
  ...
  "Welcome to “{0}”, {1}. Have fun!": "Willkommen bei {0}, {1}. Viel Spaß!",
  "Xml-Rpc Count": "Xml-Rpc-Anfragen",
  ...
  "{0} accounts sorted by {1} in {2} order.": "Status: {0} Sortierung: {1} {2}",
  "{0} active": "{0} aktiv",
  ...
  "{0} sites sorted by {1} in {2} order.": "Status: {0} Sortierung: {1} {2}.",
  "{0} story": "{0} Beitrag",
  "{0} stories": "{0} Beiträge",
  "{0} total": "{0} gesamt",
  "{0} vote": "{0} Stimme",
