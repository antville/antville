...
global.messages['de'] = {
  ...
  "HTML": "HTML",
  "Have a lot of fun!": "Viele Späße!",
  "Have fun!": "Viel Vergnügen!",
  "Health": "Statusmonitor",
  "Hello {0}.": "Hallo {0}.",
  "Hide": "Verstecken",
  "ID": "ID",
  "If the user did not include contact information in the message itself, you can send your reply via the user’s contact form [2].": "Falls der Nachricht keine Kontaktinformationen hinzugefügt wurden, können Sie Ihre Antwort über das Kontaktformular senden [2].",
  ...
  "Please enter your message to the user below.": "Bitte geben Sie Ihre Nachricht ein.",
  ...
  "Since you are an administrator of this Antville installation you are entitled to manage <a href=\"{0}\">sites</a> and <a href=\"{1}\">accounts</a>, monitor all <a href=\"{2}\">activity</a>, configure the <a href=\"{3}\">setup</a> and much more.": "Da Sie Admin dieser Antville-Installation sind, haben Sie auch die Berechtigung, <a href=\"{0}\">Websites</a> und <a href=\"{1}\">Konten</a> zu verwalten, alle <a href=\"{2}\">Aktivitäten</a> zu verfolgen, sowie die <a href=\"{3}\">Konfiguration</a> zu verändern.",
  "Site": "Site",
  ...
  "Sorry, the user name you entered already exists. Please enter a different one.": "Bedaure, der von Ihnen eingegebene Kontoname ist bereits vorhanden. Bitte geben Sie einen anderslautenden ein.",
  "Sorry, the username you entered is too long. Please choose a shorter one.": "Bedaure, der von Ihnen eingegebene Kontoname ist zu lang. Bitte geben Sie einen kürzeren ein.",
  ...
  "Sorry, your input did not match any registered user.": "Bedaure, Ihre Eingabe ergab keine Treffer bei den registrierten Konten.",
  "Source": "Quelle",
  "Source: {0}": "Quelle: {0}",
  "Start": "Start",
  ...
  "The user {0} has added your account to the list of members of the site {1} at {2}.": "{0} hat Ihr Konto zur Mitgliederliste der Website {1} unter {2} hinzugefügt.",
  "The user {0} has modified your membership of the site {1} at {2}.": "{0} hat Ihre Mitgliedschaft bei der Website {1} unter {2} geändert.",
  ...
  "This message was sent to you by an anonymous user of the site {0} [1].": "Diese Nachricht wurde Ihnen von einem unbekannten Konto der Website {0} gesendet [1].",
  "This message was sent to you by the user {0} of the site {1} [1].": "Diese Nachricht wurde Ihnen vom Konto {0} der Website {1} gesendet [1].",
  ...
  "Vote": "Abstimmen",
  "Warning!": "Warnung!",
  "We are sorry to inform you that the user {0} has cancelled your membership of the site {1} at {2}.": "Wir bedauern Ihnen mitzuteilen, dass {0} Ihre Mitgliedschaft bei der Website {1} unter {2} beendet hat.",
  "Welcome": "Willkommen",
  ...
  "[{0}] Message from anonymous user": "[{0}] Nachricht von unbekanntem Konto",
  ...
  "a site // accusative": "einen Beitrag",
