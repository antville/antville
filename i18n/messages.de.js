...
global.messages['de'] = {
  ...
  "Archive": "Archiv",
  "Are you sure you want to add this URL to the referrer filter? Edit it below to filter a pattern only.": "Sind Sie sicher, dass Sie diesen Rückverweis filtern wollen? Sie können ihn bearbeiten, um nur ein Schema zu filtern.",
  ...
  "The only owner of a site cannot be removed.": "Bedaure, die einzige Eigentümerin einer Website kann nicht gelöscht werden.",
  ...
  "This message was sent to you by an anonymous user of the site {0} [1].": "Diese Nachricht wurde Ihnen von einem unbekannten Benutzer der Website {0} gesendet [1].",
  ...
  "You are about to delete the site {0}.": "Sie sind im Begriff, die Site {0} zu löschen.",
