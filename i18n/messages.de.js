...
global.messages['de'] = {
  ...
  "Updated Terms &amp; Conditions": "Geänderte Nutzungsbedingungen",
  ...
  "{0}% in the last 5 min.": "{0}% in den letzten 5 Min.",
  "{0}% total": "{0}% gesamt",
  "{0}Download the archive{1} or click “Export” to create a new one.": "{0}Laden Sie das Archiv herunter{1} oder klicken Sie »Exportieren«, um ein neues zu erstellen.",
};
