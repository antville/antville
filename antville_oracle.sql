----------------------------------------------------------------
-- know issues: Searching in Antville won't work because
-- it's not possible to run queries with LIKE-clauses on
-- columns of type LONG (TEXT_TEXT is a LONG column)
----------------------------------------------------------------
...
CREATE TABLE "ANTVILLE"."AV_ACCESSLOG" 
   (  "ACCESSLOG_ID" NUMBER(10) NOT NULL, 
      ...
      "ACCESSLOG_REFERRER" VARCHAR2(1024),
...
CREATE TABLE "ANTVILLE"."AV_FILE" 
   (  "FILE_ID" NUMBER(10) NOT NULL,
      ...
      "FILE_SIZE" NUMBER(10),
      "FILE_DESCRIPTION" VARCHAR2(2048),
...
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (5,'smalltrans','smalltrans','gif',98,30,'resident of antville.org');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (6,'pixel','pixel','gif',1,1,'pixel');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT) values (7,'headbg','headbg','gif',3,52);
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (8,'menu','menu','gif',36,13,'menu');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (9,'recent','recent','gif',123,13,'recently modified');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (10,'status','status','gif',48,13,'status');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (11,'dot','dot','gif',30,30,'dots');
insert into "ANTVILLE"."AV_IMAGE" (IMAGE_ID,IMAGE_ALIAS,IMAGE_FILENAME,IMAGE_FILEEXT,IMAGE_WIDTH,IMAGE_HEIGHT,IMAGE_ALTTEXT) values (12,'bullet','bullet','gif',3,10,'bullet');
