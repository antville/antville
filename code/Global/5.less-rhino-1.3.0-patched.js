// FIXME: Wrapping the code in an anonymous function to keep the namespace tidy.
(function() {
// This was meant to fix the condition testing for Rhino below but 
// ({}).toString.call(environment) still returns "[object Object]" :(
var environment = {
   toString: function() {
...
// FIXME: We are using Rhino but Helma does not provide the environment object.
less = global.less = {}
tree = less.tree = {}
less.mode = 'rhino';
...
// FIXME: We do not want command line integration.
/*
...
// FIXME: End of the anonymous function wrapper (see first line).
})();
// :EMXIF
