...
if (typeof HopObject === 'function') {
   // Helma
   // Fully qualified condition would be helma.main.Server.getServer() === 'string'
   less = global.less = {}
   tree = less.tree = {}
   less.mode = 'rhino';
...
// Prevent command line integration with Helma
if (typeof HopObject === 'undefined') {
