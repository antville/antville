...
!function(r){"use strict";var t="0123456789abcdef".split(""),n=function(r,t){var n,o,a,c,i,d,v,h=1732584193,l=4023233417,s=2562383102,g=271733878;n=!t&&/[^\x00-\x7F]/.test(r)?u(r):f(r);for(var m=0,p=n.length;p>m;m+=16)0===m?(o=n[m+0]-680876937,o=(o<<7|o>>>25)-271733879<<0,i=n[m+1]-117830708+(2004318071&o^-1732584194),i=(i<<12|i>>>20)+o<<0,c=n[m+2]-1126478375+((-271733879^o)&i^-271733879),c=(c<<17|c>>>15)+i<<0,a=n[m+3]-1316259209+((i^o)&c^o),a=(a<<22|a>>>10)+c<<0):(o=h,a=l,c=s,i=g,o+=(i^a&(c^i))+n[m+0]-680876936,o=(o<<7|o>>>25)+a<<0,i+=(c^o&(a^c))+n[m+1]-389564586,i=(i<<12|i>>>20)+o<<0,c+=(a^i&(o^a))+n[m+2]+606105819,c=(c<<17|c>>>15)+i<<0,a+=(o^c&(i^o))+n[m+3]-1044525330,a=(a<<22|a>>>10)+c<<0),o+=(i^a&(c^i))+n[m+4]-176418897,o=(o<<7|o>>>25)+a<<0,i+=(c^o&(a^c))+n[m+5]+1200080426,i=(i<<12|i>>>20)+o<<0,c+=(a^i&(o^a))+n[m+6]-1473231341,c=(c<<17|c>>>15)+i<<0,a+=(o^c&(i^o))+n[m+7]-45705983,a=(a<<22|a>>>10)+c<<0,o+=(i^a&(c^i))+n[m+8]+1770035416,o=(o<<7|o>>>25)+a<<0,i+=(c^o&(a^c))+n[m+9]-1958414417,i=(i<<12|i>>>20)+o<<0,c+=(a^i&(o^a))+n[m+10]-42063,c=(c<<17|c>>>15)+i<<0,a+=(o^c&(i^o))+n[m+11]-1990404162,a=(a<<22|a>>>10)+c<<0,o+=(i^a&(c^i))+n[m+12]+1804603682,o=(o<<7|o>>>25)+a<<0,i+=(c^o&(a^c))+n[m+13]-40341101,i=(i<<12|i>>>20)+o<<0,c+=(a^i&(o^a))+n[m+14]-1502002290,c=(c<<17|c>>>15)+i<<0,a+=(o^c&(i^o))+n[m+15]+1236535329,a=(a<<22|a>>>10)+c<<0,o+=(c^i&(a^c))+n[m+1]-165796510,o=(o<<5|o>>>27)+a<<0,i+=(a^c&(o^a))+n[m+6]-1069501632,i=(i<<9|i>>>23)+o<<0,c+=(o^a&(i^o))+n[m+11]+643717713,c=(c<<14|c>>>18)+i<<0,a+=(i^o&(c^i))+n[m+0]-373897302,a=(a<<20|a>>>12)+c<<0,o+=(c^i&(a^c))+n[m+5]-701558691,o=(o<<5|o>>>27)+a<<0,i+=(a^c&(o^a))+n[m+10]+38016083,i=(i<<9|i>>>23)+o<<0,c+=(o^a&(i^o))+n[m+15]-660478335,c=(c<<14|c>>>18)+i<<0,a+=(i^o&(c^i))+n[m+4]-405537848,a=(a<<20|a>>>12)+c<<0,o+=(c^i&(a^c))+n[m+9]+568446438,o=(o<<5|o>>>27)+a<<0,i+=(a^c&(o^a))+n[m+14]-1019803690,i=(i<<9|i>>>23)+o<<0,c+=(o^a&(i^o))+n[m+3]-187363961,c=(c<<14|c>>>18)+i<<0,a+=(i^o&(c^i))+n[m+8]+1163531501,a=(a<<20|a>>>12)+c<<0,o+=(c^i&(a^c))+n[m+13]-1444681467,o=(o<<5|o>>>27)+a<<0,i+=(a^c&(o^a))+n[m+2]-51403784,i=(i<<9|i>>>23)+o<<0,c+=(o^a&(i^o))+n[m+7]+1735328473,c=(c<<14|c>>>18)+i<<0,a+=(i^o&(c^i))+n[m+12]-1926607734,a=(a<<20|a>>>12)+c<<0,d=a^c,o+=(d^i)+n[m+5]-378558,o=(o<<4|o>>>28)+a<<0,d=a^c,i+=(d^o)+n[m+8]-2022574463,i=(i<<11|i>>>21)+o<<0,v=i^o,c+=(v^a)+n[m+11]+1839030562,c=(c<<16|c>>>16)+i<<0,v=i^o,a+=(v^c)+n[m+14]-35309556,a=(a<<23|a>>>9)+c<<0,d=a^c,o+=(d^i)+n[m+1]-1530992060,o=(o<<4|o>>>28)+a<<0,d=a^c,i+=(d^o)+n[m+4]+1272893353,i=(i<<11|i>>>21)+o<<0,v=i^o,c+=(v^a)+n[m+7]-155497632,c=(c<<16|c>>>16)+i<<0,v=i^o,a+=(v^c)+n[m+10]-1094730640,a=(a<<23|a>>>9)+c<<0,d=a^c,o+=(d^i)+n[m+13]+681279174,o=(o<<4|o>>>28)+a<<0,d=a^c,i+=(d^o)+n[m+0]-358537222,i=(i<<11|i>>>21)+o<<0,v=i^o,c+=(v^a)+n[m+3]-722521979,c=(c<<16|c>>>16)+i<<0,v=i^o,a+=(v^c)+n[m+6]+76029189,a=(a<<23|a>>>9)+c<<0,d=a^c,o+=(d^i)+n[m+9]-640364487,o=(o<<4|o>>>28)+a<<0,d=a^c,i+=(d^o)+n[m+12]-421815835,i=(i<<11|i>>>21)+o<<0,v=i^o,c+=(v^a)+n[m+15]+530742520,c=(c<<16|c>>>16)+i<<0,v=i^o,a+=(v^c)+n[m+2]-995338651,a=(a<<23|a>>>9)+c<<0,o+=(c^(a|~i))+n[m+0]-198630844,o=(o<<6|o>>>26)+a<<0,i+=(a^(o|~c))+n[m+7]+1126891415,i=(i<<10|i>>>22)+o<<0,c+=(o^(i|~a))+n[m+14]-1416354905,c=(c<<15|c>>>17)+i<<0,a+=(i^(c|~o))+n[m+5]-57434055,a=(a<<21|a>>>11)+c<<0,o+=(c^(a|~i))+n[m+12]+1700485571,o=(o<<6|o>>>26)+a<<0,i+=(a^(o|~c))+n[m+3]-1894986606,i=(i<<10|i>>>22)+o<<0,c+=(o^(i|~a))+n[m+10]-1051523,c=(c<<15|c>>>17)+i<<0,a+=(i^(c|~o))+n[m+1]-2054922799,a=(a<<21|a>>>11)+c<<0,o+=(c^(a|~i))+n[m+8]+1873313359,o=(o<<6|o>>>26)+a<<0,i+=(a^(o|~c))+n[m+15]-30611744,i=(i<<10|i>>>22)+o<<0,c+=(o^(i|~a))+n[m+6]-1560198380,c=(c<<15|c>>>17)+i<<0,a+=(i^(c|~o))+n[m+13]+1309151649,a=(a<<21|a>>>11)+c<<0,o+=(c^(a|~i))+n[m+4]-145523070,o=(o<<6|o>>>26)+a<<0,i+=(a^(o|~c))+n[m+11]-1120210379,i=(i<<10|i>>>22)+o<<0,c+=(o^(i|~a))+n[m+2]+718787259,c=(c<<15|c>>>17)+i<<0,a+=(i^(c|~o))+n[m+9]-343485551,a=(a<<21|a>>>11)+c<<0,h=h+o<<0,l=l+a<<0,s=s+c<<0,g=g+i<<0;return e(h)+e(l)+e(s)+e(g)},e=function(r){for(var n="",e=0;4>e;e++){var o=e<<3;n+=t[r>>o+4&15]+t[r>>o&15]}return n},o=function(r){for(var t=[],n=0,e=0;e<r.length;e++){var o=r.charCodeAt(e);128>o?t[n++]=o:2048>o?(t[n++]=192|o>>6,t[n++]=128|63&o):55296>o||o>=57344?(t[n++]=224|o>>12,t[n++]=128|o>>6&63,t[n++]=128|63&o):(o=65536+((1023&o)<<10|1023&r.charCodeAt(++e)),t[n++]=240|o>>18,t[n++]=128|o>>12&63,t[n++]=128|o>>6&63,t[n++]=128|63&o)}return t},f=function(r){var t,n=r.length,e=(n+8>>6)+1,o=e<<4,f=[];for(t=0;o>t;++t)f[t]=0;for(t=0;n>t;++t)f[t>>2]|=r.charCodeAt(t)<<((3&t)<<3);return f[t>>2]|=128<<((3&t)<<3),f[o-2]=n<<3,f},u=function(r){var t,n=o(r),e=n.length,f=(e+8>>6)+1,u=f<<4,a=[];for(t=0;u>t;++t)a[t]=0;for(t=0;e>t;++t)a[t>>2]|=n[t]<<((3&t)<<3);return a[t>>2]|=128<<((3&t)<<3),a[u-2]=e<<3,a};"undefined"!=typeof module?module.exports=n:r&&(r.md5=n)}(this);
