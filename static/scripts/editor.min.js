...
!function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],e):e(CodeMirror)}(function(e){"use strict";e.defineMode("javascript",function(t,r){function n(e){for(var t,r=!1,n=!1;null!=(t=e.next());){if(!r){if("/"==t&&!n)return;"["==t?n=!0:n&&"]"==t&&(n=!1)}r=!r&&"\\"==t}}function a(e,t,r){return Ce=e,qe=r,t}function i(e,t){var r=e.next();if('"'==r||"'"==r)return t.tokenize=o(r),t.tokenize(e,t);if("."==r&&e.match(/^\d+(?:[eE][+\-]?\d+)?/))return a("number","number");if("."==r&&e.match(".."))return a("spread","meta");if(/[\[\]{}\(\),;\:\.]/.test(r))return a(r);if("="==r&&e.eat(">"))return a("=>","operator");if("0"==r&&e.eat(/x/i))return e.eatWhile(/[\da-f]/i),a("number","number");if("0"==r&&e.eat(/o/i))return e.eatWhile(/[0-7]/i),a("number","number");if("0"==r&&e.eat(/b/i))return e.eatWhile(/[01]/i),a("number","number");if(/\d/.test(r))return e.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/),a("number","number");if("/"==r)return e.eat("*")?(t.tokenize=c,c(e,t)):e.eat("/")?(e.skipToEnd(),a("comment","comment")):$e(e,t,1)?(n(e),e.match(/^\b(([gimyu])(?![gimyu]*\2))+\b/),a("regexp","string-2")):(e.eat("="),a("operator","operator",e.current()));if("`"==r)return t.tokenize=u,u(e,t);if("#"==r)return e.skipToEnd(),a("error","error");if(He.test(r))return">"==r&&t.lexical&&">"==t.lexical.type||(e.eat("=")?"!"!=r&&"="!=r||e.eat("="):/[<>*+\-]/.test(r)&&(e.eat(r),">"==r&&e.eat(r))),a("operator","operator",e.current());if(Ue.test(r)){e.eatWhile(Ue);var i=e.current();if("."!=t.lastType){if(Be.propertyIsEnumerable(i)){var s=Be[i];return a(s.type,s.style,i)}if("async"==i&&e.match(/^(\s|\/\*.*?\*\/)*[\(\w]/,!1))return a("async","keyword",i)}return a("variable","variable",i)}}function o(e){return function(t,r){var n,o=!1;if(Se&&"@"==t.peek()&&t.match(De))return r.tokenize=i,a("jsonld-keyword","meta");for(;null!=(n=t.next())&&(n!=e||o);)o=!o&&"\\"==n;return o||(r.tokenize=i),a("string","string")}}function c(e,t){for(var r,n=!1;r=e.next();){if("/"==r&&n){t.tokenize=i;break}n="*"==r}return a("comment","comment")}function u(e,t){for(var r,n=!1;null!=(r=e.next());){if(!n&&("`"==r||"$"==r&&e.eat("{"))){t.tokenize=i;break}n=!n&&"\\"==r}return a("quasi","string-2",e.current())}function s(e,t){t.fatArrowAt&&(t.fatArrowAt=null);var r=e.string.indexOf("=>",e.start);if(!(r<0)){if(Ne){var n=/:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(e.string.slice(e.start,r));n&&(r=n.index)}for(var a=0,i=!1,o=r-1;o>=0;--o){var c=e.string.charAt(o),u=Fe.indexOf(c);if(u>=0&&u<3){if(!a){++o;break}if(0==--a){"("==c&&(i=!0);break}}else if(u>=3&&u<6)++a;else if(Ue.test(c))i=!0;else{if(/["'\/]/.test(c))return;if(i&&!a){++o;break}}}i&&!a&&(t.fatArrowAt=o)}}function f(e,t,r,n,a,i){this.indented=e,this.column=t,this.type=r,this.prev=a,this.info=i,null!=n&&(this.align=n)}function l(e,t){for(var r=e.localVars;r;r=r.next)if(r.name==t)return!0;for(var n=e.context;n;n=n.prev)for(var r=n.vars;r;r=r.next)if(r.name==t)return!0}function d(e,t,r,n,a){var i=e.cc;for(Je.state=e,Je.stream=a,Je.marked=null,Je.cc=i,Je.style=t,e.lexical.hasOwnProperty("align")||(e.lexical.align=!0);;){if((i.length?i.pop():We?j:g)(r,n)){for(;i.length&&i[i.length-1].lex;)i.pop()();return Je.marked?Je.marked:"variable"==r&&l(e,n)?"variable-2":t}}}function p(){for(var e=arguments.length-1;e>=0;e--)Je.cc.push(arguments[e])}function m(){return p.apply(null,arguments),!0}function k(e){function t(t){for(var r=t;r;r=r.next)if(r.name==e)return!0;return!1}var n=Je.state;if(Je.marked="def",n.context){if(t(n.localVars))return;n.localVars={name:e,next:n.localVars}}else{if(t(n.globalVars))return;r.globalVars&&(n.globalVars={name:e,next:n.globalVars})}}function v(e){return"public"==e||"private"==e||"protected"==e||"abstract"==e||"readonly"==e}function y(){Je.state.context={prev:Je.state.context,vars:Je.state.localVars},Je.state.localVars=Ke}function b(){Je.state.localVars=Je.state.context.vars,Je.state.context=Je.state.context.prev}function w(e,t){var r=function(){var r=Je.state,n=r.indented;if("stat"==r.lexical.type)n=r.lexical.indented;else for(var a=r.lexical;a&&")"==a.type&&a.align;a=a.prev)n=a.indented;r.lexical=new f(n,Je.stream.column(),e,null,r.lexical,t)};return r.lex=!0,r}function x(){var e=Je.state;e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function h(e){function t(r){return r==e?m():";"==e?p():m(t)}return t}function g(e,t){return"var"==e?m(w("vardef",t.length),re,h(";"),x):"keyword a"==e?m(w("form"),V,g,x):"keyword b"==e?m(w("form"),g,x):"keyword d"==e?Je.stream.match(/^\s*$/,!1)?m():m(w("stat"),E,h(";"),x):"debugger"==e?m(h(";")):"{"==e?m(w("}"),G,x):";"==e?m():"if"==e?("else"==Je.state.lexical.info&&Je.state.cc[Je.state.cc.length-1]==x&&Je.state.cc.pop()(),m(w("form"),V,g,x,ce)):"function"==e?m(pe):"for"==e?m(w("form"),ue,g,x):"class"==e||Ne&&"interface"==t?(Je.marked="keyword",m(w("form"),ve,x)):"variable"==e?Ne&&"declare"==t?(Je.marked="keyword",m(g)):Ne&&("module"==t||"enum"==t||"type"==t)&&Je.stream.match(/^\s*\w/,!1)?(Je.marked="keyword","enum"==t?m(ze):"type"==t?m(Q,h("operator"),Q,h(";")):m(w("form"),ne,h("{"),w("}"),G,x,x)):Ne&&"namespace"==t?(Je.marked="keyword",m(w("form"),j,G,x)):m(w("stat"),W):"switch"==e?m(w("form"),V,h("{"),w("}","switch"),G,x,x):"case"==e?m(j,h(":")):"default"==e?m(h(":")):"catch"==e?m(w("form"),y,h("("),me,h(")"),g,x,b):"export"==e?m(w("stat"),xe,x):"import"==e?m(w("stat"),ge,x):"async"==e?m(g):"@"==t?m(j,g):p(w("stat"),j,h(";"),x)}function j(e,t){return A(e,t,!1)}function M(e,t){return A(e,t,!0)}function V(e){return"("!=e?p():m(w(")"),j,h(")"),x)}function A(e,t,r){if(Je.state.fatArrowAt==Je.stream.start){var n=r?q:C;if("("==e)return m(y,w(")"),D(me,")"),x,h("=>"),n,b);if("variable"==e)return p(y,ne,h("=>"),n,b)}var a=r?I:z;return Ge.hasOwnProperty(e)?m(a):"function"==e?m(pe,a):"class"==e||Ne&&"interface"==t?(Je.marked="keyword",m(w("form"),ke,x)):"keyword c"==e||"async"==e?m(r?M:j):"("==e?m(w(")"),E,h(")"),x,a):"operator"==e||"spread"==e?m(r?M:j):"["==e?m(w("]"),Ee,x,a):"{"==e?F(U,"}",null,a):"quasi"==e?p(T,a):"new"==e?m(O(r)):"import"==e?m(j):m()}function E(e){return e.match(/[;\}\)\],]/)?p():p(j)}function z(e,t){return","==e?m(j):I(e,t,!1)}function I(e,t,r){var n=0==r?z:I,a=0==r?j:M;return"=>"==e?m(y,r?q:C,b):"operator"==e?/\+\+|--/.test(t)||Ne&&"!"==t?m(n):Ne&&"<"==t&&Je.stream.match(/^([^>]|<.*?>)*>\s*\(/,!1)?m(w(">"),D(Q,">"),x,n):"?"==t?m(j,h(":"),a):m(a):"quasi"==e?p(T,n):";"!=e?"("==e?F(M,")","call",n):"."==e?m(N,n):"["==e?m(w("]"),E,h("]"),x,n):Ne&&"as"==t?(Je.marked="keyword",m(Q,n)):"regexp"==e?(Je.state.lastType=Je.marked="operator",Je.stream.backUp(Je.stream.pos-Je.stream.start-1),m(a)):void 0:void 0}function T(e,t){return"quasi"!=e?p():"${"!=t.slice(t.length-2)?m(T):m(j,$)}function $(e){if("}"==e)return Je.marked="string-2",Je.state.tokenize=u,m(T)}function C(e){return s(Je.stream,Je.state),p("{"==e?g:j)}function q(e){return s(Je.stream,Je.state),p("{"==e?g:M)}function O(e){return function(t){return"."==t?m(e?S:P):"variable"==t&&Ne?m(_,e?I:z):p(e?M:j)}}function P(e,t){if("target"==t)return Je.marked="keyword",m(z)}function S(e,t){if("target"==t)return Je.marked="keyword",m(I)}function W(e){return":"==e?m(x,g):p(z,h(";"),x)}function N(e){if("variable"==e)return Je.marked="property",m()}function U(e,t){if("async"==e)return Je.marked="property",m(U);if("variable"==e||"keyword"==Je.style){if(Je.marked="property","get"==t||"set"==t)return m(B);var r;return Ne&&Je.state.fatArrowAt==Je.stream.start&&(r=Je.stream.match(/^\s*:\s*/,!1))&&(Je.state.fatArrowAt=Je.stream.pos+r[0].length),m(H)}return"number"==e||"string"==e?(Je.marked=Se?"property":Je.style+" property",m(H)):"jsonld-keyword"==e?m(H):Ne&&v(t)?(Je.marked="keyword",m(U)):"["==e?m(j,J,h("]"),H):"spread"==e?m(M,H):"*"==t?(Je.marked="keyword",m(U)):":"==e?p(H):void 0}function B(e){return"variable"!=e?p(H):(Je.marked="property",m(pe))}function H(e){return":"==e?m(M):"("==e?p(pe):void 0}function D(e,t,r){function n(a,i){if(r?r.indexOf(a)>-1:","==a){var o=Je.state.lexical;return"call"==o.info&&(o.pos=(o.pos||0)+1),m(function(r,n){return r==t||n==t?p():p(e)},n)}return a==t||i==t?m():m(h(t))}return function(r,a){return r==t||a==t?m():p(e,n)}}function F(e,t,r){for(var n=3;n<arguments.length;n++)Je.cc.push(arguments[n]);return m(w(t,r),D(e,t),x)}function G(e){return"}"==e?m():p(g,G)}function J(e,t){if(Ne){if(":"==e)return m(Q);if("?"==t)return m(J)}}function K(e){if(Ne&&":"==e)return Je.stream.match(/^\s*\w+\s+is\b/,!1)?m(j,L,Q):m(Q)}function L(e,t){if("is"==t)return Je.marked="keyword",m()}function Q(e,t){return"variable"==e||"void"==t?"keyof"==t?(Je.marked="keyword",m(Q)):(Je.marked="type",m(Z)):"string"==e||"number"==e||"atom"==e?m(Z):"["==e?m(w("]"),D(Q,"]",","),x,Z):"{"==e?m(w("}"),D(X,"}",",;"),x,Z):"("==e?m(D(Y,")"),R):void 0}function R(e){if("=>"==e)return m(Q)}function X(e,t){return"variable"==e||"keyword"==Je.style?(Je.marked="property",m(X)):"?"==t?m(X):":"==e?m(Q):"["==e?m(j,J,h("]"),X):void 0}function Y(e){return"variable"==e?m(Y):":"==e?m(Q):void 0}function Z(e,t){return"<"==t?m(w(">"),D(Q,">"),x,Z):"|"==t||"."==e||"&"==t?m(Q):"["==e?m(h("]"),Z):"extends"==t||"implements"==t?(Je.marked="keyword",m(Q)):void 0}function _(e,t){if("<"==t)return m(w(">"),D(Q,">"),x,Z)}function ee(){return p(Q,te)}function te(e,t){if("="==t)return m(Q)}function re(e,t){return"enum"==t?(Je.marked="keyword",m(ze)):p(ne,J,ie,oe)}function ne(e,t){return Ne&&v(t)?(Je.marked="keyword",m(ne)):"variable"==e?(k(t),m()):"spread"==e?m(ne):"["==e?F(ne,"]"):"{"==e?F(ae,"}"):void 0}function ae(e,t){return"variable"!=e||Je.stream.match(/^\s*:/,!1)?("variable"==e&&(Je.marked="property"),"spread"==e?m(ne):"}"==e?p():m(h(":"),ne,ie)):(k(t),m(ie))}function ie(e,t){if("="==t)return m(M)}function oe(e){if(","==e)return m(re)}function ce(e,t){if("keyword b"==e&&"else"==t)return m(w("form","else"),g,x)}function ue(e,t){return"await"==t?m(ue):"("==e?m(w(")"),se,h(")"),x):void 0}function se(e){return"var"==e?m(re,h(";"),le):";"==e?m(le):"variable"==e?m(fe):p(j,h(";"),le)}function fe(e,t){return"in"==t||"of"==t?(Je.marked="keyword",m(j)):m(z,le)}function le(e,t){return";"==e?m(de):"in"==t||"of"==t?(Je.marked="keyword",m(j)):p(j,h(";"),de)}function de(e){")"!=e&&m(j)}function pe(e,t){return"*"==t?(Je.marked="keyword",m(pe)):"variable"==e?(k(t),m(pe)):"("==e?m(y,w(")"),D(me,")"),x,K,g,b):Ne&&"<"==t?m(w(">"),D(ee,">"),x,pe):void 0}function me(e,t){return"@"==t&&m(j,me),"spread"==e?m(me):Ne&&v(t)?(Je.marked="keyword",m(me)):p(ne,J,ie)}function ke(e,t){return"variable"==e?ve(e,t):ye(e,t)}function ve(e,t){if("variable"==e)return k(t),m(ye)}function ye(e,t){return"<"==t?m(w(">"),D(ee,">"),x,ye):"extends"==t||"implements"==t||Ne&&","==e?("implements"==t&&(Je.marked="keyword"),m(Ne?Q:j,ye)):"{"==e?m(w("}"),be,x):void 0}function be(e,t){return"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t||Ne&&v(t))&&Je.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(Je.marked="keyword",m(be)):"variable"==e||"keyword"==Je.style?(Je.marked="property",m(Ne?we:pe,be)):"["==e?m(j,J,h("]"),Ne?we:pe,be):"*"==t?(Je.marked="keyword",m(be)):";"==e?m(be):"}"==e?m():"@"==t?m(j,be):void 0}function we(e,t){return"?"==t?m(we):":"==e?m(Q,ie):"="==t?m(M):p(pe)}function xe(e,t){return"*"==t?(Je.marked="keyword",m(Ae,h(";"))):"default"==t?(Je.marked="keyword",m(j,h(";"))):"{"==e?m(D(he,"}"),Ae,h(";")):p(g)}function he(e,t){return"as"==t?(Je.marked="keyword",m(h("variable"))):"variable"==e?p(M,he):void 0}function ge(e){return"string"==e?m():"("==e?p(j):p(je,Me,Ae)}function je(e,t){return"{"==e?F(je,"}"):("variable"==e&&k(t),"*"==t&&(Je.marked="keyword"),m(Ve))}function Me(e){if(","==e)return m(je,Me)}function Ve(e,t){if("as"==t)return Je.marked="keyword",m(je)}function Ae(e,t){if("from"==t)return Je.marked="keyword",m(j)}function Ee(e){return"]"==e?m():p(D(M,"]"))}function ze(){return p(w("form"),ne,h("{"),w("}"),D(Ie,"}"),x,x)}function Ie(){return p(ne,ie)}function Te(e,t){return"operator"==e.lastType||","==e.lastType||He.test(t.charAt(0))||/[,.]/.test(t.charAt(0))}function $e(e,t,r){return t.tokenize==i&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}var Ce,qe,Oe=t.indentUnit,Pe=r.statementIndent,Se=r.jsonld,We=r.json||Se,Ne=r.typescript,Ue=r.wordCharacters||/[\w$\xa1-\uffff]/,Be=function(){function e(e){return{type:e,style:"keyword"}}var t=e("keyword a"),r=e("keyword b"),n=e("keyword c"),a=e("keyword d"),i=e("operator"),o={type:"atom",style:"atom"};return{if:e("if"),while:t,with:t,else:r,do:r,try:r,finally:r,return:a,break:a,continue:a,new:e("new"),delete:n,void:n,throw:n,debugger:e("debugger"),var:e("var"),const:e("var"),let:e("var"),function:e("function"),catch:e("catch"),for:e("for"),switch:e("switch"),case:e("case"),default:e("default"),in:i,typeof:i,instanceof:i,true:o,false:o,null:o,undefined:o,NaN:o,Infinity:o,this:e("this"),class:e("class"),super:e("atom"),yield:n,export:e("export"),import:e("import"),extends:n,await:n}}(),He=/[+\-*&%=<>!?|~^@]/,De=/^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,Fe="([{}])",Ge={atom:!0,number:!0,variable:!0,string:!0,regexp:!0,this:!0,"jsonld-keyword":!0},Je={state:null,column:null,marked:null,cc:null},Ke={name:"this",next:{name:"arguments"}};return x.lex=!0,{startState:function(e){var t={tokenize:i,lastType:"sof",cc:[],lexical:new f((e||0)-Oe,0,"block",!1),localVars:r.localVars,context:r.localVars&&{vars:r.localVars},indented:e||0};return r.globalVars&&"object"==typeof r.globalVars&&(t.globalVars=r.globalVars),t},token:function(e,t){if(e.sol()&&(t.lexical.hasOwnProperty("align")||(t.lexical.align=!1),t.indented=e.indentation(),s(e,t)),t.tokenize!=c&&e.eatSpace())return null;var r=t.tokenize(e,t);return"comment"==Ce?r:(t.lastType="operator"!=Ce||"++"!=qe&&"--"!=qe?Ce:"incdec",d(t,r,Ce,qe,e))},indent:function(t,n){if(t.tokenize==c)return e.Pass;if(t.tokenize!=i)return 0;var a,o=n&&n.charAt(0),u=t.lexical;if(!/^\s*else\b/.test(n))for(var s=t.cc.length-1;s>=0;--s){var f=t.cc[s];if(f==x)u=u.prev;else if(f!=ce)break}for(;("stat"==u.type||"form"==u.type)&&("}"==o||(a=t.cc[t.cc.length-1])&&(a==z||a==I)&&!/^[,\.=+\-*:?[\(]/.test(n));)u=u.prev;Pe&&")"==u.type&&"stat"==u.prev.type&&(u=u.prev);var l=u.type,d=o==l;return"vardef"==l?u.indented+("operator"==t.lastType||","==t.lastType?u.info+1:0):"form"==l&&"{"==o?u.indented:"form"==l?u.indented+Oe:"stat"==l?u.indented+(Te(t,n)?Pe||Oe:0):"switch"!=u.info||d||0==r.doubleIndentSwitch?u.align?u.column+(d?0:1):u.indented+(d?0:Oe):u.indented+(/^(?:case|default)\b/.test(n)?Oe:2*Oe)},electricInput:/^\s*(?:case .*?:|default:|\{|\})$/,blockCommentStart:We?null:"/*",blockCommentEnd:We?null:"*/",blockCommentContinue:We?null:" * ",lineComment:We?null:"//",fold:"brace",closeBrackets:"()[]{}''\"\"``",helperType:We?"json":"javascript",jsonldMode:Se,jsonMode:We,expressionAllowed:$e,skipExpression:function(e){var t=e.cc[e.cc.length-1];t!=j&&t!=M||e.cc.pop()}}}),e.registerHelper("wordChars","javascript",/[\w$]/),e.defineMIME("text/javascript","javascript"),e.defineMIME("text/ecmascript","javascript"),e.defineMIME("application/javascript","javascript"),e.defineMIME("application/x-javascript","javascript"),e.defineMIME("application/ecmascript","javascript"),e.defineMIME("application/json",{name:"javascript",json:!0}),e.defineMIME("application/x-json",{name:"javascript",json:!0}),e.defineMIME("application/ld+json",{name:"javascript",jsonld:!0}),e.defineMIME("text/typescript",{name:"javascript",typescript:!0}),e.defineMIME("application/typescript",{name:"javascript",typescript:!0})});
