...
change column MODIFIER MEMBERSHIP_F_USER_MODIFIER mediumint(10) null,
change column MODIFYTIME MEMBERSHIP_MODIFYTIME datetime null,
drop primary key,
drop index IDX_WEBLOG_ID,
...
change column USER_ID POLL_F_USER_CREATOR mediumint(10) null,
change column TITLE POLL_TITLE varchar(255) null,
change column QUESTION POLL_QUESTION mediumtext null,
drop column ISONLINE,
change column CLOSED POLL_CLOSED tinyint(1) null,
change column CLOSETIME POLL_CLOSETIME datetime null,
change column CREATETIME POLL_CREATETIME datetime null,
change column MODIFYTIME POLL_MODIFYTIME datetime null,
drop primary key,
drop index IDX_WEBLOG_ID,
drop index IDX_USER_ID,
...
change column CREATETIME SKIN_CREATETIME datetime null,
change column CREATOR SKIN_F_USER_CREATOR mediumint(10) null,
...
change column SYSADMIN_ID SYSLOG_F_USER_CREATOR mediumint(10) null,
change column CREATETIME SYSLOG_CREATETIME datetime null,
drop primary key,
...
change column AUTHOR TEXT_F_USER_CREATOR mediumint(10) null,
change column MODIFIER TEXT_F_USER_MODIFIER mediumint(10) null,
change column CREATETIME TEXT_CREATETIME datetime null,
