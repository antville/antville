...
## Add deleted status to content table
ALTER TABLE `antville`.`content` CHANGE COLUMN `status` `status` 
   enum('deleted','closed','pending','readonly','public','shared','open')
...
update membership set role = 'owner' where role = 'Owner';
